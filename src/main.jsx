...
const projects = [
  {
    number: "01",
    type: "FLAGSHIP PRODUCT ENGINEERING",
...
function Loader({ loaded }) {
  return (
    <div
      className={`loader-screen ${loaded ? "loader-screen--hide" : ""}`}
      aria-live="polite"
    >
...
function App() {
  ...
  const [darkMode, setDarkMode] = useState(
    () => localStorage.getItem("chetan-theme") === "dark",
  );
      ...
      <div className="site">
        <header className="topbar">
          ...
          <div className="header-actions">
            <a
              className="header-social linkedin-social"
            ...
            <a
              ...
              href="https://github.com/chetanvn20"
              target="_blank"
              rel="noreferrer"
          ...
          <section id="about" className="about section">
            ...
            <div className="about-copy">
              ...
              <p>
                ...
                APIs, building integrations, working with cloud infrastructure
                or connecting an interface to the systems underneath.
              </p>
                ...
                <div className="job-body">
                  ...
                  <div className="job-columns">
                    <div>
                      ...
                      <span>
                        Node.js services, REST APIs and full-stack features for
                        a large production sales enablement platform.
                      </span>
                    </div>
            ...
            <div className="contact-grid">
              ...
              <div className="contact-details">
                ...
                <a
                  ...
                  rel="noreferrer"
                >
                  <span className="contact-icon linkedin-contact">in</span>
